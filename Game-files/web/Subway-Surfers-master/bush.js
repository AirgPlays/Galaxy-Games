function Bush(gl,texture,xl,zl) {
...
function drawBush(gl,vp, programInfo, buffers, deltaTime,speed) {
    ...
    mat4.translate(modelViewMatrix,modelViewMatrix,[3*buffers.x,-0.3,buffers.z]);
