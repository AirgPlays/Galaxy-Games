function Boot(gl,texture,xl,yl,zl) {
...
function drawBoot(gl,vp, programInfo, buffers, deltaTime,speed) {
    ...
    mat4.translate(modelViewMatrix,modelViewMatrix,[2.5*buffers.x,-0.3,buffers.z]);
    mat4.scale(modelViewMatrix,modelViewMatrix,[0.5,0.5,1]);
