function Player(gl,xl) {
    ...
    const faceColors = [
        [1.0, 1.0, 0.81, 1.0],    // Front face: red
        [1.0, 1.0, 0.81, 1.0],    // Back
        [1.0, 1.0, 0.81, 1.0],    // Top
        [1.0, 1.0, 0.81, 1.0],    // Bottom
        [1.0, 1.0, 0.81, 1.0],    // Left
        [1.0, 1.0, 0.81, 1.0], 
           // Right
...
function drawPlayer(gl,vp,programInfo, buffers, deltaTime) {
    ...
    if(speed < 0.1400)
    {
        ...
        speed = 0.1400
    // console.log(speed)
    if(jetpackboost) speed = 0.4;
    currentPos -= speed;
    currentPos = Math.round(currentPos*10000)/10000;
    $("#run_score").text("Score: " + Math.floor(-1*currentPos).toString());
    mat4.translate(modelViewMatrix,modelViewMatrix,[-3*currentLane,-0.3,1.3 + currentPos]);
    if(jetpackboost) mat4.translate(modelViewMatrix,modelViewMatrix,[0,2.0,0]);
    if(jetpackboost) mat4.rotate(modelViewMatrix,modelViewMatrix,-45,[1,0,0]);
    mat4.translate(modelViewMatrix,modelViewMatrix,[0,spaceY + crouchY,0]);
