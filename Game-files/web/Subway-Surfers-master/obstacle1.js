function Train(gl,texture,xl,zl,width,height,breadth,speed) {
...
function drawTrain(gl,vp, programInfo, buffers, deltaTime) {
    ...
    mat4.translate(modelViewMatrix,     // destination matrix
        ...
        [buffers.x*2.7, 0,buffers.z + buffers.speed]);  // amount to translate
    buffers.z = buffers.z + buffers.speed;
